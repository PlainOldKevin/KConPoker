// v2: Grouped by player for two-card hand logic (auto-advance, etc.).
...
// v2: Flat list for "all player hand slots" checks and mapping.
...
// v2: Union type for any single player hand slot.
